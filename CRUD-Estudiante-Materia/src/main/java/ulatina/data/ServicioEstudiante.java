...
public class ServicioEstudiante extends Servicio{
    ...
    public void insertarEstudiante(Estudiante estudiante) throws ClassNotFoundException, SQLException{
    ...
    public void actualizarEstudiante(Estudiante estudiante) throws ClassNotFoundException, SQLException{
        PreparedStatement pstmt = null;
        try {
            super.conectarBD();
    ...
    public void eliminarEstudiante(Estudiante estudiante) throws ClassNotFoundException, SQLException{
        PreparedStatement pstmt = null;
        try {
            super.conectarBD();
    ...
    public List<Estudiante> obtenerEstudiantes() throws ClassNotFoundException, SQLException{
